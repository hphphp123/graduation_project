...
len2a=len_val/2+1;
psi_val=zeros(len2a,1);

parameters_noise =  struct('n',2,'len',len_val,'noise_ps',Sf_val,'noise_tild',Sf_val,'gamma',ones(len_val,1),'Sf',Sf_val,...
            'Smin',Sf_val,'S',Sf_val,'S_tild',Sf_val,'GH1',zeros(len_val,1),'Smin_tild',Sf_val,'Smin_sw',Sf_val,'Smin_sw_tild',Sf_val,...
            'stored_min',max(ns_ps)*ones(len_val,U_val),'stored_min_tild',max(ns_ps)*ones(len_val,U_val),'u1',1,'u2',1,'j',1,...
...
parameters_enhance = struct('len',len_val,'Gmin',10^(-10/10),'noise_ps',Sf_val,'eps_min',eps_min_val,'beta',0.7,'psi',psi_val,...
                    'psi_min',0.1,'psi_max',0.3162,'psi_pmin',1,'psi_pmax',10,'psi_fr',1000,'psi_peak',0,'qmax',0.95,'sigout',ones(len_val,1),...
                   'alpha',alpha_val,'GH1',zeros(len_val,1),'gamma',ones(len_val,1),'eps',zeros(len_val,1));
