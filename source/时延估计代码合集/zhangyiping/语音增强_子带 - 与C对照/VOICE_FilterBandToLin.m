function [line] = VOICE_FilterBandToLin(mel)
...
line = zeros(160,1);
for i=1:1:160
    id1 = g_aswBandTable(i)+1;
    id2 = g_aswBandTable(i)+1+1;
    line(i,1) = mel(id1,1)*g_afBandFilter(i);
    line(i,1) = line(i,1) + mel(id2,1)*(1-g_afBandFilter(i));
end
